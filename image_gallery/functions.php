...
class imagegallery {
	...
	function theme_bodyopen($_zp_themeroot) {
		$location = getOption('tm2_caption_location');
		?>
		<script type="text/javascript">
		  $(function() {
		  	var galleries = $('.ad-gallery').adGallery({
		  	  ...
		  	  effect: '<?php echo getOption('tm2_transition'); ?>', // or 'slide-vert', 'resize', 'fade', 'none' or false
		...
		if (isImagePage()) {
			...
			<div id="images">
	          ...
	          <?php
			    ...
			    <div id="caption"<?php if (getOption('tm2_caption_location')=='none') echo ' style="display:none"'?>>
			    </div>
